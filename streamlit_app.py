...
# =========================================================
# Sidebar Toggle 응급 복구 패치
# - 기존 CSS가 숨긴 sidebar open/close 버튼과 아이콘을 다시 살림
# =========================================================
st.markdown(
    """
    <style>
    ...
    html body .stApp button[aria-label="사이드바 닫기"] {
        ...
        background: rgba(24,14,46,0.96) !important;
        border: 1px solid rgba(184,132,255,0.72) !important;
