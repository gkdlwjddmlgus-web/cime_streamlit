...
def kpi_tooltip_label(label: str, desc: str) -> str:
    return (
        f'<div class="board-kpi-label">{safe_html(label)}'
        f'<span class="trail-tooltip-wrap">'
        f'<span class="trail-tooltip-icon">?</span>'
        f'<span class="trail-tooltip-text">{html_lib.escape(desc)}</span>'
        f'</span></div>'
    )
