...
# =========================================================
# 전역 Header / Sidebar Toggle 안정화 패치
# - 헤더/툴바/헤더 액션 영역을 숨기지 않음
# - Streamlit 기본 사이드바 열기/닫기 버튼과 기본 아이콘을 유지
# - 기존 커스텀 토글의 svg/span 숨김 및 ::before 대체 아이콘 방식 제거
# =========================================================
st.markdown(
    """
    <style>
    :root {
        ...
        --cime-toggle-size: 38px;
        --cime-toggle-top: 64px;
        --cime-toggle-open-left: 18px;
        --cime-toggle-close-right-gap: 18px;
        --cime-toggle-bg: rgba(24, 14, 46, 0.92);
        --cime-toggle-border: rgba(184, 132, 255, 0.62);
    ...
    /* 헤더 내부 기본 요소 복구: toolbar/action 영역을 숨기지 않음 */
    ...
    /* 실제 버튼: 기본 아이콘/기능은 유지하고 배경만 살짝 보정 */
    ...
    html body .stApp button[aria-label="사이드바 닫기"] {
        ...
        background: var(--cime-toggle-bg) !important;
        color: var(--cime-toggle-icon) !important;
        fill: var(--cime-toggle-icon) !important;
        stroke: var(--cime-toggle-icon) !important;
